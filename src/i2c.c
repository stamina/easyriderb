 ...
 *
 *  Library based on Peter Fleury's.
...
#define SCL_CLOCK  100000L // 100 khz default I2C speed

void i2c_init(void) {
  TWSR = 0; // no prescaling
  TWBR = ((F_CPU/SCL_CLOCK)-16)/2; // bit rate number for 100khz, this number is 92 with a 20mhz avr crystal
}
